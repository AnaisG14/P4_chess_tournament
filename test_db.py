...
# serialized_anais = Anais.serialized()
# info_anais_bis = deserialisation.deserialized(serialized_anais)
...
deserialisation_tournois = deserialisation.Deserialisation(serialized_tournois1)
tournois2 = deserialisation_tournois.deserialized_tournament()
print(tournois2)